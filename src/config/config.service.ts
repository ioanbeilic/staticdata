  ...
  constructor() {
    ...
    if (isDevelopmentEnv) {
      ...
      this.envConfig = {
        ...
        WORLD_TO_ME_PASSWORLD: process.env.WORLD_TO_ME_PASSWORLD as string,
        ...
        ABREU_PASSWORLD: process.env.ABREU_PASSWORLD as string,
        ...
        TOUR_DIEZ_PASSWORLD: process.env.TOUR_DIEZ_PASSWORLD as string,
        TOUR_DIEZ_URL_V3: process.env.TOUR_DIEZ_URL_V3 as string,
        TOUR_DIEZ_USER_V3: process.env.TOUR_DIEZ_USER_V3 as string,
        TOUR_DIEZ_PASSWORLD_V3: process.env.TOUR_DIEZ_PASSWORLD_V3 as string,
        ...
        TOR_TRAVEL_FTP_PASSWORLD: process.env.TOR_TRAVEL_FTP_PASSWORLD as string,
      };
    }
  }
